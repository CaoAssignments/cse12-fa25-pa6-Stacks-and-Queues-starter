...
There is an FAQ post on Piazza. **Due date: Thursday, November 13 @ 11:59 PM PST**
...
A core goal of this course is to teach students how to identify the time complexity (Big-O notation) of an algorithm. In practice, you can use this to understand how the runtime of an algorithm will grow with larger and larger inputs. In this section, you will test your understanding on using a deque versus a linked list to implement a queue. This time, you only need to fill out the form on Gradescope.

Your task: Fill out PA6 Task 2: Runtime form on Gradescope. This will NOT be eligible for resubmission.
...
* **Runtime Analysis** [5 points]
    * Fill out **PA6 Task 2: Runtime** on Gradescope.
